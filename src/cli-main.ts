  ...
  switch (subcommand) {
    case 'skills':
      if (args[0] === 'install') {
        ...
        console.error(
          'Unknown skills subcommand. Usage: npx @damoqiongqiu/mcp-local-rag skills install [options]'
        )
        console.error(
          'Run "npx @damoqiongqiu/mcp-local-rag skills install --help" for more information.'
        )
        process.exit(1)
      }
      break
